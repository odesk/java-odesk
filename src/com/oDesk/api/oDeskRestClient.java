...
public class oDeskRestClient {
    ...
    public static JSONObject getJSONObject(HttpGet request) throws JSONException {
        return oDeskRestClient.getJSONObject(request, METHOD_GET, new HashMap<String, String>());
    }
    ...
    public static JSONObject getJSONObject(HttpGet request, Integer method) throws JSONException {
        return oDeskRestClient.getJSONObject(request, method, new HashMap<String, String>());
    }
    ...
    private static JSONObject genError(HttpResponse response) throws JSONException {
    	String code		= response.getFirstHeader("X-Odesk-Error-Code").getValue();
    	String message	= response.getFirstHeader("X-Odesk-Error-Message").getValue();
